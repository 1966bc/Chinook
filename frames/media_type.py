...
class UI(tk.Toplevel):
    def __init__(self, parent, index=None):
        super().__init__(name="media_type")
    ...
    def init_ui(self):
        ...
        r = 0
        c = 1
        ttk.Label(w, text="Media Type:",).grid(row=r, sticky=tk.W)
        self.txTitle = ttk.Entry(w, textvariable=self.media_type)
    ...
    def set_values(self,):
        ...
        self.media_type.set(self.selected_item[1])
